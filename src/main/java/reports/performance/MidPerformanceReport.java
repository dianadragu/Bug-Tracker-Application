...
public class MidPerformanceReport implements PerformanceReportStrategy {
    private static final double CLOSED_TICKETS_INTAKE = 0.5;
    private static final double HIGH_PRIORITY_TICKETS_INTAKE = 0.7;
    private static final double RESOLUTION_TIME_INTAKE = 0.3;
    ...
    public double calculatePerformance(DevStatistics stats) {
        double score = Math.max(0, CLOSED_TICKETS_INTAKE * stats.getClosedTickets() +
                            ...
                            SeniorityBonus.MID.getBonusScore();
